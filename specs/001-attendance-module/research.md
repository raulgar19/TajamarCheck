...
- Decision: Keep the controller thin, route all attendance operations through `IAttendanceRepository`/`AttendanceRepository`, and isolate business rules in a service layer when needed.
...
## Decision 3: Network validation via middleware
...
## Decision 4: Hostname transport strategy
...
## Decision 5: Scalar API Reference in development
...
## Decision 6: Angular service-first API access
...
## Decision 7: pnpm as the only frontend installer
